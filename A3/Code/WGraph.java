...
class Edge{    /** edge 类 */
    ...
    Edge(int i, int j, int w,int direction){
        this.nodes[0] = i;
        this.nodes[1] = j;
        this.weight = w;
...
public class WGraph{     /** WGraph 类 */

    private ArrayList<Edge> edges = new ArrayList<Edge>();          // edge
    private ArrayList<Integer> nodes = new ArrayList<Integer>();    // node
    private int nb_nodes = 0;                                       // node 数量
    private Integer source = 0;                                     // source
    private Integer destination =0;                                 // destination

    WGraph() {
    }
    
    WGraph(WGraph graph) {  // 克隆graph
    ...
    public void setEdge(Integer node1, Integer node2, int weight,int direction){
        for(Edge e:edges){
            if(e.nodes[0]==node1 && e.nodes[1]==node2){
                e.weight=weight;
